...
const LEGACY_CARD_POOL = {
    ...
    overcharge_gambit: { card_id: "overcharge_gambit", display_name: "Kaioken", effect: "If you have 5 or fewer Flux, gain 6 Flux.", card_kind: "pulse", mechanics: [{ type: "gain_victory_points_if_at_most", threshold: 5, amount: 6 }] },
    download_scan: { card_id: "download_scan", display_name: "Download", effect: "Look at the top 5 cards of your deck and add any Core cards to your hand. Then, put the remaining cards on the bottom in the same order.", card_kind: "pulse", mechanics: [{ type: "scan_deck", count: 5, card_ids: ["victory_point_1"] }] },
    ...
    charge_ki: { card_id: "charge_ki", display_name: "Charge Ki", effect: "Activate this card only if you haven't played a card this turn. Gain 1 Ki. End your turn.", card_kind: "immutable", immutable: true, activation_limit: "repeatable", requires_no_prior_play: true, mechanics: [{ type: "gain_ki", amount: 1 }, { type: "end_own_turn" }] },
